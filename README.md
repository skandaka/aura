...
- View usage statistics, route quality metrics
- Export data in JSON or CSV format

#### Settings & Accessibility
- Click the "⚙️ Settings" button
- Customize theme, font size, and accessibility options
- Enable/disable notifications and data collection
...
```
Calculate accessible routes with comprehensive analysis.

### Obstacle Management
```
POST /api/obstacles          # Report new obstacle
GET /api/obstacles           # Get obstacles in area
...
**Database Issues:**
- Delete `aura.db` and restart to reset database
...
- Routing algorithms inspired by OpenStreetMap
